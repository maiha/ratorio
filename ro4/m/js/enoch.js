...
$(document).ready(function() {
    ...
    class EnochModal {
        ...
        static REGIONS = {
            ...
            ACC1:        { label: 'ア1', equipId: '#OBJID_ACCESSARY_1', cardIds: ['#OBJID_ACCESSARY_1_CARD_1', '#OBJID_ACCESSARY_1_CARD_4'] },
            ACC2:        { label: 'ア2', equipId: '#OBJID_ACCESSARY_2', cardIds: ['#OBJID_ACCESSARY_2_CARD_1', '#OBJID_ACCESSARY_2_CARD_4'] },
        };
